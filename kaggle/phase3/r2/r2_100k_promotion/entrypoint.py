...
if __name__ == "__main__":
    ...
    run(
        ...
        r1_output,
        Path(os.getenv("PHASE3_OUTPUT", "/kaggle/working/r2_100k_promotion")),
        Path(os.getenv("R2_PROMOTION_CONFIG", "/kaggle/input/track5-r2-promotion-config/promotion_config.json")),
    )

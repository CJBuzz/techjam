...
if __name__=="__main__":
 relaunch_with_torchrun_if_needed(__file__,sys.argv[1:]);u=discover_output("R4");run(Path(__file__).with_name("config.json"),Path("/kaggle/input/track5-phase3-data/train_validation_manifest.jsonl"),u/"recommended_candidate.json",u,Path("/kaggle/working/mean_patch"))

...
if __name__ == "__main__":
    ...
    run(
        ...
        r2_output,
        Path(os.getenv("PHASE3_OUTPUT", "/kaggle/working/r3_100k_promotion")),
        Path(os.getenv("R3_PROMOTION_CONFIG", "/kaggle/input/track5-r3-promotion-config/promotion_config.json")),
    )

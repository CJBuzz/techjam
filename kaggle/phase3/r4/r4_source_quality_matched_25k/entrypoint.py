...
if __name__ == "__main__":
    ...
    run(Path(__file__).with_name("config.json"), Path(os.getenv("PHASE3_MANIFEST", "/kaggle/input/track5-phase3-data/train_validation_manifest.jsonl")), upstream / "recommended_candidate.json", upstream, Path(os.getenv("PHASE3_OUTPUT", "/kaggle/working/r4_source_quality_matched_25k")))

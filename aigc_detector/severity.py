...
def main() -> None:
    ...
    results: dict[str, object] = {
        "_metadata": {
            ...
            "threshold": threshold,
            "color_definition": "exact shared brightness/contrast/saturation factor (0.8 or 1.2)",
        },
        "cells": {},
    }
    ...
    for operation, value in selected:
        ...
        for source in sorted(set(sources)):
            ...
            source_metrics = classification_metrics(labels[mask], probabilities[mask], threshold)
